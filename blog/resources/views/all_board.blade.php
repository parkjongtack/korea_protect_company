...
<div id="sub_sec">
    ...
    <div class="sub_con">
        <div class="sub_side">
            <ul>
                <li><a href="#none" class="bold f_nanum">해피콜상담서비스</a></li>
                <li><a href="#none">상담센터 소개</a></li>
                <li class="on"><a href="#none">FAQ</a></li>
                <li><a href="#none">상담하기</a></li>
            </ul>
        </div>
        <div class="sub_outer">
            <div class="sub_nav">
    ...
    <div class="sub_con">
        <div class="sub_side">
            <ul>
                ...
                <li><a href="#none">법령정보</a></li>
                <li><a href="#none">보안서식</a></li>
                <li class="on"><a href="#none">자료실</a></li>
                <li><a href="#none">뉴스레터</a></li>
            </ul>
        </div>
        <div class="sub_outer">
            <div class="sub_nav">
