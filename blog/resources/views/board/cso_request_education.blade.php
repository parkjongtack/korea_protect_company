				...
				@else
					@foreach ($data as $data)
						<tr>
							...
							<td><a href="/{{ request()->segment(1) }}/ey_write_notice/modify/?board_idx={{ $data->idx }}">{{ $data->writer_corporation_divide }}</a></td>
							<td>{{ $data->writer_corporation }}</td>
							<td>{{ $data->writer_grade }}</td>
